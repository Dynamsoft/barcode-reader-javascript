...
function(){return{torch:this._videoCapabilities?this._videoCapabilities.torch||!1:!1,focus:!1}};BR.Scanner.prototype.turnOnTorch=function(){return this.isSupportTorch()?(this._advancedVideoSettings.torch=!0,this._videoTrack.applyConstraints({advanced:[this._advancedVideoSettings]})):Promise.reject("not support")};BR.Scanner.prototype.turnOffTorch=function(){return this.isSupportTorch?(this._advancedVideoSettings.torch=!1,this._videoTrack.applyConstraints({advanced:[this._advancedVideoSettings]})):
Promise.reject("not support")};BR.Scanner.prototype._cloneDecodeResults=function(b,c){if(b instanceof Array){var a=[];b=$jscomp.makeIterator(b);for(var d=b.next();!d.done;d=b.next())a.push(this._cloneDecodeResults(d.value,c));return a}a=JSON.parse(JSON.stringify(b,function(a,b){if("oriVideoCanvas"!=a&&"searchRegionCanvas"!=a)return b}));c||(a.oriVideoCanvas=b.oriVideoCanvas,a.searchRegionCanvas=b.searchRegionCanvas);return a};BR.Scanner.prototype._loopReadVideo=function(){var b=this;if(this._isOpen)if(this._video.paused)BR._onLog&&
BR._onLog("Video is paused. Ask in 1s."),setTimeout(function(){b._loopReadVideo()},this._intervalDetectVideoPause);else{BR._onLog&&BR._onLog("======= once read =======");var c=(new Date).getTime();(function(){var a=JSON.parse(JSON.stringify(b.searchRegion));a.bAddOriVideoCanvasToResult=b.bAddOriVideoCanvasToResult;a.bAddSearchRegionCanvasToResult=b.bAddSearchRegionCanvasToResult;return!b._bTryTakePhoto||!b._imageCapture||b._advancedVideoSettings&&b._advancedVideoSettings.torch||"live"!=b._videoTrack.readyState||
!b._videoTrack.enabled||b._videoTrack.muted?b.barcodeReader.decodeVideo.apply(b.barcodeReader,[b._video,a]):b._imageCapture.takePhoto(b._photoSettings).then(function(c){a.videoWidth=b._video.videoWidth;a.videoHeight=b._video.videoHeight;return b._videoOrientation||"image/jpeg"!=c.type?c:new Promise(function(a){EXIF.getData(c,function(){b._videoOrientation=EXIF.getTag(this,"Orientation");a(c)})})}).then(function(c){a._videoOrientation=b._videoOrientation;return b.barcodeReader._decodeBlob(c,a)})})().then(function(a){var d=
(new Date).getTime();BR._onLog&&BR._onLog("time cost: "+(d-c)+"ms");++b._frameCount;BR._onLog&&BR._onLog(a);for(var k=[],l=$jscomp.makeIterator(a),e=l.next();!e.done;e=l.next()){e=e.value;for(var f=!1,g=0;g<b.arrDiffCodeInfo.length;++g){var n=b.arrDiffCodeInfo[g];if(n.result.BarcodeText==e.BarcodeText&&n.result.BarcodeFormat==e.BarcodeFormat){n.time=d;n.result=b._cloneDecodeResults(e,!0);++n.count;f=!0;0!=(e.BarcodeFormat&BR.EnumBarcodeFormat.OneD)&&(g=n.frameCounts,g.push(b._frameCount),g.length==
b._1DTrustFrameCount?k.push(e):g.length>b._1DTrustFrameCount&&g.shift());break}}f||(b.arrDiffCodeInfo.push({result:b._cloneDecodeResults(e,!0),time:d,count:1}),0==(e.BarcodeFormat&BR.EnumBarcodeFormat.OneD)?k.push(e):b.arrDiffCodeInfo[b.arrDiffCodeInfo.length-1].frameCounts=[b._frameCount])}for(l=0;l<b.arrDiffCodeInfo.length;++l)e=b.arrDiffCodeInfo[l],e.time+b.duplicateForgetTime<d&&(0==(e.result.BarcodeFormat&BR.EnumBarcodeFormat.OneD)?b.arrDiffCodeInfo.splice(l,1):(e=e.frameCounts,b._frameCount-
e[e.length-1]>=b._1DRememberFrameCount&&b.arrDiffCodeInfo.splice(l,1)));if(b.onFrameRead)b.onFrameRead(b._cloneDecodeResults(a));a=$jscomp.makeIterator(k);for(e=a.next();!e.done;e=a.next())if(d=e.value,b.onUnduplicatedRead)b.onUnduplicatedRead(d.BarcodeText,b._cloneDecodeResults(d));setTimeout(function(){b._loopReadVideo()},b.intervalTime)}).catch(function(a){BR._onLog&&BR._onLog(a.message||a);setTimeout(function(){b._loopReadVideo()},b.intervalTime);if("platform error"!=a.message)throw console.error(a.message),
a;})}}}
var BarcodeScanner=BarcodeReader.BarcodeScanner=BarcodeReader.Scanner,EXIF=dbrEnv._bDom?function(){function b(a,b){b||a.match(/^data:([^;]+);base64,/mi);a=a.replace(/^data:([^;]+);base64,/gmi,"");a=atob(a);b=a.length;for(var c=new ArrayBuffer(b),d=new Uint8Array(c),e=0;e<b;e++)d[e]=a.charCodeAt(e);return c}function c(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.responseType="blob";c.onload=function(a){200!=this.status&&0!==this.status||b(this.response)};c.send()}function a(a,g){function h(b){var c=d(b);
a:{var h=new DataView(b);if(255!=h.getUint8(0)||216!=h.getUint8(1))h=!1;else{for(var f=2,m=b.byteLength;f<m;){var k=h,q=f;if(56===k.getUint8(q)&&66===k.getUint8(q+1)&&73===k.getUint8(q+2)&&77===k.getUint8(q+3)&&4===k.getUint8(q+4)&&4===k.getUint8(q+5)){k=h.getUint8(f+7);0!==k%2&&(k+=1);0===k&&(k=4);m=f+8+k;f=h.getUint16(f+6+k);h=m;m=new DataView(b);k={};for(q=h;q<h+f;){if(28===m.getUint8(q)&&2===m.getUint8(q+1)){var l=m.getUint8(q+2);if(l in A){var v=m.getInt16(q+3);l=A[l];v=e(m,q+5,v);k.hasOwnProperty(l)?
