...
e.asm = function(a, b) {
  b.memory = Aa;
  b.table = new WebAssembly.Table({initial:7394, maximum:7394, element:"anyfunc"});
  a = pb(b);
...
var Z = e.asm({}, {ClassHandle:Sc, ClassHandle_clone:$c, ClassHandle_delete:ad, ClassHandle_deleteLater:fd, ClassHandle_isAliasOf:Rc, ClassHandle_isDeleted:bd, DYNAMICTOP_PTR:ta, RegisteredClass:kd, RegisteredPointer:Gd, RegisteredPointer_deleteObject:ud, RegisteredPointer_destructor:td, RegisteredPointer_fromWireType:Ed, RegisteredPointer_getPointee:sd, __assert_fail:function(a, b, c, d) {
  ...
  "uncaught_exception" in Ae ? Ae.s++ : Ae.s = 1;
...
}, _emscripten_syscall_munmap:Dc, _emscripten_traverse_stack:ee, _emval_decref:Td, _emval_incref:function(a) {
  4 < a && (W[a].pa += 1);
  ...
  e.abort();
}, atexit:xb, attachFinalizer:Zc, clock:$d, constNoSmartPtrRawPointerToWireType:md, count_emval_handles:Ud, craftInvokerFunction:Pd, createNamedFunction:Lc, demangle:sb, demangleAll:tb, detachFinalizer:Wc, dlclose:function() {
  return ae.apply(null, arguments);
}, dlopen:ae, dlsym:function() {
  return ae.apply(null, arguments);
}, downcastPointer:vd, embind__requireFunction:Id, embind_init_charCodes:Fc, embind_repr:nd, emscripten_get_callstack_js:fe, emscripten_get_heap_size:ua, emscripten_log:function(a, b) {
  var c = r[b >> 2];
  b += 4;
  var d = "";
  if (c) {
  ...
  return ya | 0;
}, getTypeName:Kd, get_first_emval:Vd, getenv:me, heap32VectorToArray:Qd, init_ClassHandle:gd, init_RegisteredPointer:Fd, init_embind:Ad, init_emval:Wd, integerReadValueFromPointer:Yd, invoke_ii:Ce, invoke_iii:De, invoke_iiii:Ee, invoke_iiiii:Fe, invoke_iiiiii:Ge, invoke_iiiiiii:He, invoke_iiiiiiii:Ie, invoke_iiiiiiiiii:Je, invoke_vi:Ke, invoke_vii:Le, invoke_viii:Me, invoke_viiii:Ne, invoke_viiiii:Oe, invoke_viiiiii:Pe, invoke_viiiiiiiii:Qe, jsStackTrace:ub, localtime:function(a) {
  return re(a, 1532192);
}, localtime_r:re, longjmp:ke, makeClassHandle:Dd, makeLegalFunctionName:Kc, memcpy:function(a, b, c) {
  a |= 0;
  b |= 0;
  c |= 0;
  var d;
  ...
  return 0;
}, readLatin1String:T, registerType:Qc, releaseClassHandle:Yc, replacePublicSymbol:Hd, requireRegisteredType:Zd, runDestructor:Xc, runDestructors:Od, saveSetjmp:ie, sbrk:function(a) {
  a |= 0;
  var b = ua() | 0;
  var c = r[ta >> 2] | 0;
  var d = c + a | 0;
  ...
  ya = a | 0;
}, shallowCopyInternalPointer:Tc, simpleReadValueFromPointer:rd, sqrt:bb, stackTrace:vb, strftime:ze, strftime_l:function(a, b, c, d) {
  return ze(a, b, c, d);
  ...
  a && (r[a >> 2] = b);
  return b;
}, tzset:ne, upcastPointer:ld, validateThis:Rd, whenDependentTypesAreResolved:V}, buffer), Re = Z.__wasm_call_ctors;
...
var Uf = Z.dynCall_iidiiii;
Z.dynCall_iidiiii = function() {
  assert(F, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!G, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Uf.apply(null, arguments);
};
var Vf = Z.dynCall_iiiiij;
Z.dynCall_iiiiij = function() {
  assert(F, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!G, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Vf.apply(null, arguments);
};
var Wf = Z.dynCall_iiiiid;
Z.dynCall_iiiiid = function() {
  assert(F, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!G, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Wf.apply(null, arguments);
};
var Xf = Z.dynCall_iiiiijj;
Z.dynCall_iiiiijj = function() {
  assert(F, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!G, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Xf.apply(null, arguments);
};
var Yf = Z.dynCall_iiiiiijj;
...
}, Ae = e.__ZSt18uncaught_exceptionv = function() {
  assert(F, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!G, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
...
e.dynCall_if = function() {
  assert(F, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!G, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return e.asm.dynCall_if.apply(null, arguments);
};
...
function Ie(a, b, c, d, f, g, h, k) {
  var u = n();
  try {
    return eg(a, b, c, d, f, g, h, k);
  } catch (q) {
    p(u);
    if (q !== q + 0 && "longjmp" !== q) {
      throw q;
...
function Je(a, b, c, d, f, g, h, k, u, q) {
  var v = n();
  try {
    return fg(a, b, c, d, f, g, h, k, u, q);
  } catch (x) {
    p(v);
    if (x !== x + 0 && "longjmp" !== x) {
      throw x;
...
function Qe(a, b, c, d, f, g, h, k, u, q) {
  var v = n();
  try {
    mg(a, b, c, d, f, g, h, k, u, q);
  } catch (x) {
    p(v);
    if (x !== x + 0 && "longjmp" !== x) {
      throw x;
